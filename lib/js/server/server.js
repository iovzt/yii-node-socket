...
var funcHelpers = require('./components/func_helpers.js');
var express = require('express');
var app = express();
if (funcHelpers.isEmptyObject(serverConfiguration.serverOptions)) {
    var server = require(serverConfiguration.scheme).createServer(app);
} else {
    var server = require(serverConfiguration.scheme).createServer(serverConfiguration.serverOptions, app);
}
